...
function setFood() {
  axios.get(url)
    .then((response) => {
      ...
      if (currentdate === 1) {
        let mondayFood = "<p>Montag</p>" + "<p>" + Food1Monday + "</p>" + "<p>" + Food2Monday + "</p>";
        foodOfTheDay = mondayFood;
        console.log(`Montag:\n${Food1Monday}\n${Food2Monday}`);
      } else if (currentdate === 2) {
        foodOfTheDay = "<p>Dienstag</p>" + "<p>" + Food1Tuesday + "</p>" + "<p>" + Food2Tuesday + "</p>";
      } else if (currentdate === 3) {
        foodOfTheDay = "<p>Mittwoch</p>" + "<p>" + Food1Wednesday + "</p>" + "<p>" + Food2Wednesday + "</p>";
        console.log(`Mittwoch:\n${Food1Wednesday}\n${Food2Wednesday}`);
      } else if (currentdate === 4) {
        let thursdayFood = "<p>Donnerstag</p>" + "<p>" + Food1Thursday + "</p>" + "<p>" + Food2Thursday + "</p>";
        foodOfTheDay = thursdayFood;
        console.log(`Donnerstag:\n${Food1Thursday}\n${Food2Thursday}`);
      } else if (currentdate === 5) {
        foodOfTheDay = "<p>Freitag</p>" + "<p>" + Food1Friday + "</p>" + "<p>" + Food2Friday + "</p>";
        console.log(`Freitag:\n${Food1Friday}\n${Food2Friday}`);
      } else {
...
setInterval(setFood, 60 * 60 * 1000);
